...
class Core_Tests extends Base\TestCase {
	...
	public function test_i18n() {
		...
		\WP_Mock::onFilter( 'plugin_locale' )->with( 'en_US', 'wally-core' )->reply( 'en_US' );
		\WP_Mock::userFunction( 'load_textdomain', array(
			'times' => 1,
			'args' => array( 'wally-core', 'lang_dir/wally-core/wally-core-en_US.mo' ),
		) );
		...
		\WP_Mock::userFunction( 'load_plugin_textdomain', array(
			'times' => 1,
			'args' => array( 'wally-core', false, 'path/languages/' ),
		) );
	...
	public function test_init() {
		// Setup
		\WP_Mock::expectAction( 'wally_core_init' );
